 ...
 *
 ******************************************************************************/
#define	SRC_GRAY8_INIT do {			\
	soff = (sy + y) * sstride + sx;		\
	sacc = src[soff];			\
	soff++;					\
} while (0)

#define	SRC_GRAY8_NEXT do {			\
	sacc = src[soff];			\
	soff++;					\
} while (0)
