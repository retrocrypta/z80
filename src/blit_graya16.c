 ...
 *
 ******************************************************************************/
#define	SRC_GRAYA16_INIT do {			\
	soff = (sy + y) * sstride + sx * 4;	\
	sacc = 256*src[soff] + src[soff+1];	\
	alpha = 256*src[soff+2] + src[soff+3];	\
	soff += 4;				\
} while (0)

#define	SRC_GRAYA16_NEXT do {			\
	sacc = 256*src[soff] + src[soff+1];	\
	alpha = 256*src[soff+2] + src[soff+3];	\
	soff += 4;				\
} while (0)
...
#undef	SRC_GRAY
#define	SRC_GRAY (sacc * 0x00010001)
