 ...
 *
 ******************************************************************************/
#define	SRC_GRAY16_INIT do {			\
	soff = (sy + y) * sstride + sx * 2;	\
	sacc = 256 * src[soff] + src[soff + 1];	\
	soff += 2;				\
} while (0)

#define	SRC_GRAY16_NEXT do {			\
	sacc = 256 * src[soff] + src[soff + 1];	\
	soff += 2;				\
} while (0)
